...
plant_chili :- isStarted(_),isPlant(_),
...
plant_paddy :- isStarted(_),isPlant(_),
...
plant_tomato :- isStarted(_),isPlant(_),
...
plant_pineapple :- isStarted(_),isPlant(_),
...
plant_strawberry :- isStarted(_),isPlant(_),
